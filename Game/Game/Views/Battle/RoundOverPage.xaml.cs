...
namespace Game.Views
{
	...
	public partial class RoundOverPage: ContentPage
	{
		...
		public void DrawDroppedItems()
		{
			...
			foreach (var data in BattleEngineViewModel.Instance.Engine.Referee.BattleScore.ItemModelDropList)
			{
		...
		/// <param name="data"></param>
		/// <returns></returns>
		public StackLayout CreatePlayerDisplayBox(DungeonFighterModel data)
		{
			if (data == null)
			{
